...
class Template:
    ...
    loader: Any = ...
    compiled: Any = ...
    def __init__(self, template_string: Any, name: str = ..., loader: Optional[Any] = ..., compress_whitespace: Any = ..., autoescape: Any = ..., whitespace: Optional[Any] = ...) -> None: ...
...
class BaseLoader:
    ...
    templates: Any = ...
    lock: Any = ...
    def __init__(self, autoescape: Any = ..., namespace: Optional[Any] = ..., whitespace: Optional[Any] = ...) -> None: ...
    def reset(self) -> None: ...
...
class _CodeWriter:
    ...
    apply_counter: int = ...
    include_stack: Any = ...
    def __init__(self, file: Any, named_blocks: Any, loader: Any, current_template: Any) -> None: ...
