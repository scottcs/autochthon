...
class BaseLog:
    ...
    def __init__(
        ...
        initial_color: int = game.const.palette.Message.default,
    ) -> None:
        self.lines: list = []
        if initial_line is not None:
            self.add(initial_line, color=initial_color)

    def add(self, message: str, color: int = game.const.palette.Message.default) -> None:
    ...
    def append(self, message: str, color: int = game.const.palette.Message.default) -> None:
